...
function BostonColorPaletteGrid({ locale, premiumLabel }) {
  return (
            ...
            <div>
              ...
              <div className="mt-6 divide-y divide-[--color-line] border border-line bg-white">
                ...
                {product.collection === "BOSTON" ? (
                  <AccordionItem title={t(locale, "product.bostonPalette")}>
                    <p className="mb-4">{t(locale, "product.bostonPaletteIntro")}</p>
