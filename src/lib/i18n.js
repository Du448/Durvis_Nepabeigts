...
const messages = {
  lt: {
    ...
    category: {
      ...
      sortNew: "Naujienos",
            size: "Matmenys",
      leafThickness: "Varčios storis",
      metalThickness: "Metalo storis",
      sealContours: "Sandarinimo kontūrai",
      sealContoursN: "{n} kontūrai",
      threshold: "Slenkstis",
      thresholdStainless: "Nerūdijančio plieno",
      thresholdSteel: "Plieninis",
      thresholdAluminumThermal: "Aliuminio su termo pertrauka",
      features: "Savybės",
      glass: "Su stiklu",
      newOnly: "Naujiena",
      offerOnly: "Akcija",
  ...
  lv: {
    ...
    category: {
      ...
      sortNew: "Jaunumi",
            size: "Izmērs",
      leafThickness: "Vērtnes biezums",
      metalThickness: "Metāla biezums",
      sealContours: "Blīvējuma kontūri",
      sealContoursN: "{n} kontūri",
      threshold: "Slieksnis",
      thresholdStainless: "Nerūsējošais tērauds",
      thresholdSteel: "Tērauds",
      thresholdAluminumThermal: "Alumīnijs ar termopārrāvumu",
      features: "Īpašības",
      glass: "Ar stiklu",
      newOnly: "Jaunums",
      offerOnly: "Akcija",
  ...
  en: {
    ...
    category: {
      ...
      sealContours: "Sealing contours",
      sealContoursN: "{n} contours",
      threshold: "Threshold",
      thresholdStainless: "Stainless steel",
      thresholdSteel: "Steel",
      thresholdAluminumThermal: "Aluminium with thermal break",
      features: "Features",
      glass: "With glass",
      newOnly: "New",
      offerOnly: "Offer",
