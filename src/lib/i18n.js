...
const messages = {
  lt: {
    ...
    product: {
      ...
      stockCountZero: "Šiuo metu šio dydžio ir krypties nėra sandėlyje.",
  ...
  lv: {
    ...
    product: {
      ...
      stockCountZero: "Šis izmērs un virziens šobrīd nav noliktavā.",
  ...
  en: {
    ...
    product: {
      ...
      stockCountZero: "This size and direction are currently out of stock.",
