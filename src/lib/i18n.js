...
const messages = {
  lt: {
    ...
    product: {
      ...
      addWishlist: "Pridėti į norus",
      freeServices: "Matavimas · Montavimas · Pristatymas visoje Lietuvoje",
      specs: "Specifikacija",
  ...
  lv: {
    ...
    product: {
      ...
      addWishlist: "Pievienot vēlmēm",
      freeServices: "Mērīšana · Montāža · Piegāde visā Lietuvā",
      specs: "Specifikācija",
  ...
  en: {
    ...
    product: {
      ...
      addWishlist: "Add to wishlist",
      freeServices: "Measurement · Installation · Delivery across Lithuania",
      specs: "Specification",
